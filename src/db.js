...
const {
 ...
 const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/aguilagrupo3`, {
...
const { Peritos, Casos} = sequelize.models;

// Aca vendrian las relaciones

// Peritos.hasMany(Casos)
//  Casos.belongsTo(Peritos)
